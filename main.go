...
func main() {
	...
	beego.Router("/sale", &c.SaleController{})
	beego.Router("/sale/cancel", &c.SaleController{}, "get:CancelSale;post:UpdateCancelSale")
	beego.Router("/sale/sale", &c.SaleController{}, "get:Sale;post:UpdateSale")
