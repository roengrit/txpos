!function ($) {
    ...
    Typeahead.prototype = {
        ...
        ajaxSource: function (data) {
            ...
            var tdata = data.ListData;
            this.ajaxToggleLoadClass(false);
            var that = this, items;            
            if (!that.ajax.xhr)
                return;
            if (that.ajax.preProcess) {
                tdata = that.ajax.preProcess(tdata);
            }
            // Save for selection retreival
            that.ajax.data = tdata;
    ...
    $.fn.typeahead.defaults = {
        ...
        scrollBar: false,
        alignWidth: true,
        menu: '<ul class="typeahead dropdown-menu drop-search"></ul>',
        item: '<li><a href="#"></a></li>',
        valueField: 'id',
        displayField: 'name',
        autoSelect: true,
